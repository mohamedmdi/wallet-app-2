  ...
  return (
    <div>
      <div className="flex">
        <aside
          id="default-sidebar"
          className="border-1 z-40 w-64 min-w-max min-h-screen overflow-auto transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
          <div className=" h-full px-3 py-4 overflow-hidden bg-gray-50 dark:bg-gray-900">
